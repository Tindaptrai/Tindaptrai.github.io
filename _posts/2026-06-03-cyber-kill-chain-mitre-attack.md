...
Bài này tổng hợp các khái niệm quan trọng trong phân tích tấn công mạng, bao gồm:
...
Mục tiêu chính là hiểu được \*\*vòng đời tấn công\*\*, attacker đang ở giai đoạn nào, đã đạt được quyền gì, và defender nên phát hiện/ngăn chặn ở đâu.
...
Hiểu Cyber Kill Chain giúp SOC analyst trả lời các câu hỏi:
...
lý tưởng nhất là chặn ở các giai đoạn sớm.
...
Thu thập thông tin mà không tương tác trực tiếp với hệ thống mục tiêu.
...
\- Xem Instagram, Facebook, mạng xã hội.
...
\- Tìm công nghệ công ty đang dùng.

\- Tìm thông tin đối tác, vendor, domain, email.



Thông tin trong job ads có thể tiết lộ:



\- Antivirus/EDR đang dùng.
...
Tương tác trực tiếp với hạ tầng mục tiêu.
...
Mục tiêu của Recon là tạo nền tảng cho các bước sau trong kill chain.
...
\*\*Weaponization\*\* là giai đoạn attacker chuẩn bị payload, exploit hoặc malware để dùng cho initial access.
...
\- Đóng gói malware vào script/executable.

\- Chuẩn bị dropper.

\- Chuẩn bị exploit cho lỗ hổng đã tìm thấy.

\- Tùy chỉnh payload dựa trên thông tin EDR/AV của mục tiêu.
